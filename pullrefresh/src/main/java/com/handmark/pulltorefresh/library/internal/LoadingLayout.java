...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    private CharSequence mRullReset;
    ...
    public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
        ...
        switch (scrollDirection) {
            case HORIZONTAL:
                LayoutInflater.from(context).inflate(getLayoutResId() == 0 ? R.layout.pull_to_refresh_header_horizontal : getLayoutResId(), this);
                break;
            case VERTICAL:
            default:
                LayoutInflater.from(context).inflate(getLayoutResId() == 0 ? R.layout.pull_to_refresh_header_vertical : getLayoutResId(), this);
                break;
        }

        mInnerLayout = (FrameLayout) findViewById(R.id.fl_inner);
        mHeaderText = (TextView) mInnerLayout.findViewById(R.id.pull_to_refresh_text);
        mHeaderProgress = findView(mInnerLayout, R.id.pull_to_refresh_progress, ProgressBar.class);
        mSubHeaderText = (TextView) mInnerLayout.findViewById(R.id.pull_to_refresh_sub_text);
        mHeaderImage = findView(mInnerLayout, R.id.pull_to_refresh_image, ImageView.class);
        ...
        switch (mode) {
            ...
            default:
                ...
                // Load in labels
                mRullReset = context.getString(R.string.pull_to_refresh_from_bottom_reset);
        ...
        switch (mode) {
            ...
            case PULL_FROM_END:
                ...
                if (attrs.hasValue(R.styleable.PullToRefresh_ptrHeaderTextColorEnd)) {
                    ColorStateList colors = attrs.getColorStateList(R.styleable.PullToRefresh_ptrHeaderTextColorEnd);
                    if (null != colors) {
                        setTextColor(colors);
                    }
                }
    ...
    public final void reset() {
        if (null != mHeaderText) {
            if (mMode == Mode.PULL_FROM_START) {
                mHeaderText.setText(mRullReset);
            } else {
                mHeaderText.setText(mPullLabel);
            }
        }
    ...
    private <T> T findView(View parentView, int resId, Class<T> targetView) {
